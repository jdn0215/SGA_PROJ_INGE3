...
const AReportes=["_successReportes", "_infoReportes", "_warningReportes", "_dangerReportes"];

const states=["alert alert-success","alert alert-info","alert alert-warning","alert alert-danger"];
const alerts=[Aclientes,Amotos,Ausuarios,ABusca,AIndex,ACitas,ACambio,AReportes];
...
/*args* where=>0 clientes, 1 motos, 2 usuarios, 3 busquedas, 4 Index,5 Citas,6 cambio de contraseña,7 Reportes
